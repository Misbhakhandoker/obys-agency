...
function cursorAnimaition() {
  ...
  var videoContent = document.querySelector("#video-container");
  var video = document.querySelector("#video-container video");
  videoContent.addEventListener("mouseenter", function () {
    videoContent.addEventListener("mousemove", function (dets) {
  ...
  videoContent.addEventListener("mouseleave", function () {
    gsap.to(".mousefollower", {
      opacity: 1,
    });
    gsap.to("#video-cursor", {
